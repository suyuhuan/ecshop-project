...
$_LANG['unrecognize_version'] ='Can\'t identify the N5 version of the backup sql.';
...
$_LANG['version_error'] ='N5 current version the %s and the backup data version the %s is different, the backup restore failure.';
