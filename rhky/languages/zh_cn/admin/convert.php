...
$_LANG['note_select_system'] = '（如果您的系统不在左边的列表中，您可以到<a href="http://www.yenyou.cn" target="_blank"><strong>我们的网站</strong></a>寻求帮助）';
$_LANG['select_charset'] = '请选择您要转换的系统使用的字符集：';
$_LANG['note_select_charset'] = '（如果你的系统使用的不是 UTF-8 字符集，转换可能需要较长时间）';
$_LANG['dir_notes'] = '请注意原商城的根目录路径请使用相对于admin目录的路径。';
