...
$_LANG['need_not_setup'] = '当您采用恩友会员系统时，无须进行设置。';
$_LANG['different_domain'] = '您设置的整合对象和 恩友 不在同一域下。<br />您将只能共享该系统的会员数据，但无法实现同时登录。';
...
$_LANG['ucenter_notice_key'] = '通信密钥用于在 UCenter 和 恩友 之间传输信息的加密，可包含任何字母及数字，请在 UCenter 与 恩友 设置完全相同的通讯密钥，以确保两套系统能够正常通信';
$_LANG['ucenter_notice_url'] = '该值在您安装完 UCenter 后会被初始化，在您 UCenter 地址或者目录改变的情况下，修改此项，一般情况请不要改动 例如: http://www.yenyou.cn (最后不要加"/")';
...
$_LANG['uc_notice_ip'] = '连接的过程中出了点问题，请您填写服务器 IP 地址，如果您的 UC 与 恩友 装在同一服务器上，我们建议您尝试填写 127.0.0.1';
