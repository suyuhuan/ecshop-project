...
$modules['02_cat_and_goods']['12_batch_pic']        = 'picture_batch.php';          //商品批量处理
$modules['02_cat_and_goods']['13_batch_add']        = 'goods_batch.php?act=add';    // 商品批量上传
$modules['02_cat_and_goods']['14_goods_export']     = 'goods_export.php?act=goods_export';//商品批量上传
...
$modules['02_cat_and_goods']['50_virtual_card_list']   = 'goods.php?act=list&extension_code=virtual_card';//虚拟商品列表
...
$modules['02_cat_and_goods']['goods_auto']             = 'goods_auto.php?act=list';//商品自动上下架
